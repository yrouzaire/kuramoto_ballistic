...
pos, thetas, omegas, psis = initialisation(N, L, L, σ, params_init)
ind_neighbours = get_list_neighbours(pos, N, L, L)
update(pos, thetas, omegas, psis, ind_neighbours, T, v0, N, L, L, dt)
@btime update(pos, thetas, omegas, psis, ind_neighbours, T, v0, N, L, L, dt)
@btime get_list_neighbours(pos, N, L, L)
